...
id -> id do utilizador 
last_login -> data de último login do utilizador 
...
{ 
"error": 1, 
"message": "Ocurreu um erro na autenticaçao, verifique se todos os campos sao válidos", 
"res": {} 
} (edited) 
...
{ 
"error": 1, 
"message": "Ocorreu um erro no registo, verifique se todos os campos sao válidos", 
"res": {} 
} 
