...
exports.CREATE_TBL_SITES = "CREATE TABLE IF NOT EXISTS " + this.TBL_SITES + "(id INT(11) NOT NULL AUTO_INCREMENT, site VARCHAR(150) NOT NULL, coordinates VARCHAR(150), PRIMARY KEY (id)) ";
...
exports.CREATE_TBL_WORKSHEET = "CREATE TABLE IF NOT EXISTS " + this.TBL_WORKSHEET + "(id int(11) NOT NULL AUTO_INCREMENT, object int(11) NOT NULL, worksheet_date DATE NOT NULL, `procedure` varchar(100) NOT NULL, observations varchar(11), materials text, amount int(11), duration int(11), technician int(11) NOT NULL, PRIMARY KEY (id), FOREIGN KEY fk_worksheet_object(object_id) REFERENCES "+ this.TBL_OBJECT + "(id), FOREIGN KEY fk_worksheet_user(technician) REFERENCES " + this.TBL_USERS + "(id))";

//--------------------------ORDEM DE CRIAÇÃO DAS TABELAS--------------------------
exports.CREATE_OREDER = [this.CREATE_TBL_USER_TYPES, this.CREATE_TBL_USERS, this.CREATE_TBL_CONTACTS, this.CREATE_TBL_MATERIALS_USED, this.CREATE_TBL_MATERIAL_TYPES, this.CREATE_TBL_SITES, this.CREATE_TBL_STYLE, this.CREATE_TBL_TECHNICS_USED , this.CREATE_TBL_SUPERCATEGORIES , this.CREATE_TBL_CATEGORIES , this.CREATE_TBL_SUBCATEGORIES, this.CREATE_TBL_OBJECT,this.CREATE_TBL_CONSERVATION, this.CREATE_TBL_ENVIRONMENT,this.CREATE_TBL_IMAGES,this.CREATE_TBL_INTERVENTION, this.CREATE_TBL_INTERVENTION_PROPOSAL, this.CREATE_TBL_MATERIALS,this.CREATE_TBL_PREVIOUS_INTERVENTIONS,this.CREATE_TBL_SOURCES,this.CREATE_TBL_TEAM,this.CREATE_TBL_TECHNICS,this.CREATE_TBL_TESTS,this.CREATE_TBL_ANALYSIS, this.CREATE_TBL_SOLUBILITY, this.CREATE_TBL_SOLUBTESTS,this.CREATE_TBL_WORKSHEET];