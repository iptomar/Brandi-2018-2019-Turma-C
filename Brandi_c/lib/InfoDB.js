...
exports.CREATE_TBL_INTERVENTION = "CREATE TABLE IF NOT EXISTS " + this.TBL_INTERVENTION + "(id INT(11) NOT NULL AUTO_INCREMENT, object_id INT(11) NOT NULL, proposal_preserve INT(1) NOT NULL, proposal_conserve INT(1) NOT NULL, proposal_restaure INT(1) NOT NULL, support TEXT, support_resources TEXT, surface TEXT, surface_resources TEXT, elements TEXT, elements_resources TEXT, observations TEXT, PRIMARY KEY (id), FOREIGN KEY fk_interventions_object(object_id) REFERENCES " + this.TBL_OBJECT + "(id))";

exports.CREATE_TBL_INTERVENTION_PROPOSAL = "CREATE TABLE IF NOT EXISTS " + this.TBL_INTERVENTION_PROPOSAL + "(id INT(11) NOT NULL AUTO_INCREMENT, object_id INT(11) NOT NULL, prop_preserve INT(1), prop_conserve INT(1), prop_restaure INT(1), support TEXT, support_resources TEXT, surface TEXT, surface_resources TEXT, elements TEXT, elements_resources TEXT, observations TEXT, proposal_date DATE, acceptation_date DATE, ipt_intervenient INT(11) NOT NULL, client_intervenient INT(11) NOT NULL, owner_preserve INT(1), owner_conserve INT(1), owner_restaure INT(1), PRIMARY KEY (id), FOREIGN KEY fk_int_proposal_object(object_id) REFERENCES " + this.TBL_OBJECT + "(id),FOREIGN KEY fk_ipt_int(ipt_intervenient) REFERENCES " + this.TBL_USERS + "(id),FOREIGN KEY fk_client_int(client_intervenient) REFERENCES " + this.TBL_CONTACTS + "(id))";
...
exports.CREATE_TBL_TESTS = "CREATE TABLE IF NOT EXISTS " + this.TBL_TESTS + "(id INT(11) NOT NULL AUTO_INCREMENT, object_id INT(11) NOT NULL, Q1 INT(1), Q2 INT(1), Q3 INT(1), Q4 INT(1), Q5 INT(1), Q6 INT(1), results TEXT, conclusions TEXT, PRIMARY KEY (id), FOREIGN KEY fk_tests_object(object_id) REFERENCES " + this.TBL_OBJECT + "(id))";
